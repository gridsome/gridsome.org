...
- Run `npm --version`.
- **The output of each of those commands should be a version number**. If entering those commands don’t show you a version number, go back and make sure you have installed **Node.js**.
