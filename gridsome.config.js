...
module.exports = {
  ...
  siteDescription: 'Gridsome is a Vue.js-powered static site generator that makes it easy and fun for developers to create beautiful JAMstack websites & PWAs that are fast by default.',
