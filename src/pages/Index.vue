...
export default {
  ...
  metaInfo: {
    title: 'Gridsome - Build a faster, better web with Vue.js',
    titleTemplate: '%s',
    meta: [
      {
        name: 'description',
        content: 'Gridsome is a Vue.js-powered  static site generator for building high-performance websites for any CMS or data API'
      }
    ]
  }
}
