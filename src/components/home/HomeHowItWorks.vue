<template>
  <Section dots="true" class="post" dark="true">
    <h5 class="text-center">How Gridsome Works</h5>

    <h2 class="text-center primary-color container-sm">01. Bring your data</h2>

    <p class="text-center container-md mb">
      Pull data from anywhere into a local unified
    ...
    <div class="cms-cols grid-cols grid-cols--collapse grid-cols--3">
      ...
      <Card style="border-radius: 0">
        <h4>CMSs</h4>
        <p>Any Headless CMS, ButterCMS, Contentful, WordPress, Drupal, DatoCMS, Sanity.io, GraphCMS etc.</p>
      </Card>
    ...
    <h2 class="text-center primary-color container-sm">02. Build with Vue.js</h2>

    <p class="text-center container-md">
      <a href="https://vuejs.org/">Vue.js</a> is a very popular, performant and approachable JavaScript framework. Build websites with
      <strong>Vue Components</strong> as building blocks with instant hot-reloading for any code change.
    </p>
    ...
    <div class="generate-html text-center">
      ...
      <span>
        ...
        <strong>
          <g-link to="/docs/how-it-works/#the-prpl-pattern">PRPL pattern</g-link>
        </strong>
      </span>
    </div>
    ...
    <h2 class="text-center primary-color container-sm">03. Deploy</h2>
    ...
    <Card class="text-center container-mini mb">
      ...
      <p>
        ...
        <g-link to="/docs/deploy-to-amazon-s3/">Amazon S3</g-link>, Surge.sh, Aerobatic, Now.sh & many more.
      </p>
    </Card>

    <p class="home-links text-center">
      <g-link to="/docs/how-it-works/">Learn more about how it works</g-link>
    </p>
  </Section>
</template>
