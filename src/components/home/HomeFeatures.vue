  ...
  <Section dots="true" primary="true" class="post">
    <div class="homepage-features grid-cols">
      ...
      <Feature>
        ...
        <p>Gridsome sites renders as pure HTML before Vue.js is loaded and SPA kicks in. This makes search engines able to crawl content, and give <strong>better SEO ranking</strong> because of the super fast loading.</p>
      </Feature>
