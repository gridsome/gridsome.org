    ...
    <div class="homepage-features grid-cols">
      ...
      <Feature>
       ...
       <Feature>
        ...
        <p>Build websites with modern tools like <strong>Vue.js, webpack and Node.js</strong>. Get hot-reloading and access to any packages from npm and write CSS in your favorite preprocessor like SASS
        </p>
      </Feature>
      ...
      <Feature>
        ...
        <p>The future of the web is JavaScript, API's, and Markup - the <strong><a href="https://jamstack.org">JAMstack</a></strong>. Gridsome uses the power of a blazing-fast <strong>static site generator</strong>, JavaScript and APIs to create stunning dynamic web experiences.
        </p>
      </Feature>
      ...
      <Feature>
        ...
        <h3>Pre-rendered and ready for any CDN</h3>
        <p>Gridsome sites are pre-rendered at build time (Static generated) and can be entirely hosted on a CDN. It can handle thousands to millions of hits without breaking - and <strong>no expensive server costs.</strong>
        </p>     
      </Feature>
    </div>
