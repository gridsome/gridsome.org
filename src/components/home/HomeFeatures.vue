  ...
  <Section dots="true" primary="true" class="post">
    <div class="homepage-features grid-cols">
      ...
      <Feature>
        ...
        <p>Gridsome automatically optimizes your frontend to load and perform fast. You get <strong>code-splitting</strong>  & automatic asset optimization out-of-the-box, with almost <strong>perfect speed scores.</strong>
        </p>     
      </Feature>
