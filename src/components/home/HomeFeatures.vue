  ...
  <Section dots="true" primary="true" class="post">
    <div class="homepage-features grid-cols">
      ...
      <Feature>
        ...
        <p>Gridsome automatically optimizes your website to load and perform fast. You get <strong>code-splitting & asset optimization</strong> out-of-the-box with almost <strong>perfect Lighthouse scores.</strong>
        </p>     
      </Feature>
